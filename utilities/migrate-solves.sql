...
SELECT 'INSERT INTO "Solves" ("SolvedAt", "PlayerId", "ChallengeId") VALUES ('''||"Solves"."SolvedAt"||''',(SELECT "Id" FROM "Players" as "p" WHERE "p"."FederatedId" = '''||"Players"."FederatedId"||'''),'''||"Solves"."ChallengeId"||''');' FROM "Solves" JOIN "Players" ON "Solves"."PlayerId" = "Players"."Id";
